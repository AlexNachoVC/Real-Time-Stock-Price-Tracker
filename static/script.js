    ...
    tickers.forEach(function(ticker) {
        $.ajax({
            ...
            success: function(data){
                ...
                $(`#${ticker}-price`).removeClass("dark-red light-red grey light-green dark-green").addClass(colorClass); 
                $(`#${ticker}-pct`).removeClass("dark-red light-red grey light-green dark-green").addClass(colorClass);    
